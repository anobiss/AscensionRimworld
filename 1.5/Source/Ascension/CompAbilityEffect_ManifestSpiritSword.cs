...
namespace Ascension
{
    public class CompAbilityEffect_ManifestSpiritSword : CompAbilityEffect
    {
        ...
        public static void SpiritSwordSpawn(Pawn pawn, IntVec3 cell)
        {
            ...
            Thing thing = ThingMaker.MakeThing(AscensionDefOf.AS_SpiritSword, null);
            thing.stackCount = 1;
            ...
            pawn.health.RemoveHediff(pawn.health.hediffSet.GetFirstHediffOfDef(AscensionDefOf.AS_SpiritSwordFusion));
        }
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            base.Apply(target, dest);
            Pawn pawn = parent.pawn;
            Hediff hediff = pawn.health.hediffSet.GetFirstHediffOfDef(AscensionDefOf.AS_SpiritSwordFusion);
