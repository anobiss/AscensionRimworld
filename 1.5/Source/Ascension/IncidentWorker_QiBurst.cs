...
namespace Ascension
{
    public class IncidentWorker_QiBurst : IncidentWorker_MakeGameCondition
    {
        ...
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            {
                if (maps[i].IsPlayerHome && !QiBurstWillEndSoon(maps[i]))
                {
                    return true;
                }
            }
        ...
        private bool QiBurstWillEndSoon(Map map)
        {
