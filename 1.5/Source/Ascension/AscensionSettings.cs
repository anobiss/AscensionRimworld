...
namespace Ascension
{
    ...
    public class AscensionMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            Rect viewRect = new Rect(0f, 0f, inRect.width - 16f, 800f); // Adjust height as needed
